...
def parse_option():
    parser = argparse.ArgumentParser(
        "MetaFG training and evaluation script", add_help=False
    )
    parser.add_argument(
        "--cfg",
        type=str,
    ...
    parser.add_argument("--num-workers", type=int, help="num of workers on dataloader ")

    parser.add_argument("--lr", type=float, metavar="LR", help="learning rate")
    parser.add_argument(
        "--weight-decay", type=float, help="weight decay (default: 0.05 for adamw)"
    )

    parser.add_argument("--min-lr", type=float, help="learning rate")
    parser.add_argument("--warmup-lr", type=float, help="warmup learning rate")
    parser.add_argument("--epochs", type=int, help="epochs")
    parser.add_argument("--warmup-epochs", type=int, help="epochs")

    parser.add_argument("--dataset", type=str, help="dataset")
    parser.add_argument(
        "--lr-scheduler-name", type=str, help="lr scheduler name,cosin linear,step"
    )
